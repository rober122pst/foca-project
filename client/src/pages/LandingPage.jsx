        ...
        <>
            <section id="header">
                ...
                <div className="cta-container">
                    <Link to="/auth?register=true" className="signup-button cta-button invert-button"></Link>
                </div>
            </section>

            <section id="start-now">
                <div className="hero-bg finisher-header" style={{ width: '100%', height: '864px' }}></div>
                <div className="wrapper-start">
                    <div className="hero-container">
                        <h1 className="title">Diga adeus à procrastinação e foque no que importa!</h1>
                        <h4 className="subtitle">
                            Transforme sua rotina em um jogo: foco, organização e produtividade com o Foca.
                        </h4>
                    </div>
                    <Link to="/auth?register=true" className="cta-button invert-button"></Link>
                </div>
            ...
            <section id="about">
                ...
                <div className="wrapper wrapper-about">
                    <div className="about-container">
                        ...
                        <h4 className="subtitle">
                            O celular vibra, a notificação chama, a vida acontece... e o estudo? Fica pra depois (ou
                            nunca). Mas calma. Tem solução.
                        </h4>
                    </div>
                </div>
            </section>
            ...
            <section id="conheca">
                <div className="wrapper wrapper-conheca">
                    <div className="conheca-container">
                        ...
                        <h4 className="subtitle">
                            Seu aliado na guerra contra o celular, os vídeos de gatinhos fofos e o “só mais uma
                            partida”. Ele segura a bronca enquanto você foca no que importa: passar, aprender e vencer.
                        </h4>
                    </div>
                    <Link to="/auth?register=true" className="cta-button"></Link>
                </div>
                <div className="image-section">
            ...
            <div className="lading-waves waves">
                ...
                <div id="rotina">
                    ...
                    <div className="wrapper wrapper-rotina">
                        <div className="rotina-container">
                            ...
                            <h4 className="subtitle">
                                No Foca, você monta sua rotina de estudo do jeitinho que quiser, com pausas, prioridades
                                e até tempo pra pensar na vida (ou dar uma olhadinha nos memes, vai). Aqui, quem manda é
                                você.
                            </h4>
                        </div>
                        <Link to="/auth?register=true" className="cta-button invert-button"></Link>
                ...
                <div id="pontos">
                    <div className="wrapper wrapper-pontos">
                        <div className="pontos-container">
                            ...
                            <h4 className="subtitle">
                                Estudar não precisa ser só sofrimento. Cada tarefa concluída viram pontos. Quanto mais
                                você foca, mais você evolui.
                            </h4>
                        </div>
                        <Link to="/auth?register=true" className="cta-button invert-button"></Link>
                    </div>
                ...
                <div id="notificacao">
                    ...
                    <div className="wrapper wrapper-notificacao">
                        <div className="notificacao-container">
                            ...
                            <h4 className="subtitle">
                                As notificações do Foca aparecem só pra dar aquele toque na hora certa. São tipo um
                                amigo que te cutuca quando você tá quase escorregando pra procrastinação.
                            </h4>
                        </div>
                        <Link to="/auth?register=true" className="cta-button invert-button"></Link>
                    </div>
                ...
                <div id="distracao">
                    <div className="wrapper wrapper-distracao">
                        <div className="distracao-container">
                            ...
                            <h4 className="subtitle">
                                Sabe aquele momento que você finalmente senta pra estudar... e dois cliques depois tá
                                vendo a letra de uma música? Então. O Foca bloqueia esses apps e jogos ladrões de
                                atenção enquanto você estuda. É tipo um segurança na porta do seu foco.
                            </h4>
                        </div>
                        <Link to="/auth?register=true" className="cta-button invert-button"></Link>
                    </div>
            ...
            <section id="cta-final">
                <div className="cta-final-container">
                    ...
                    <p className="subtitle">
                        Deixe de ser um procrastinador a partir de agora. Não deixe o Tik Tok te vencer de novo!
                    </p>
                    <Link to="/auth?register=true" className="cta-button invert-button"></Link>
                </div>
            </section>
