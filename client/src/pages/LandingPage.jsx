...
function LandingPage() {
    useEffect(() => {
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    return this.o.shapes[
                                        Math.floor(
                                            Math.random() * this.o.shapes.length
                                        )
                                    ];
                                },
                            },
                            ...
                            },
                            {
                                ...
                                value: function (t, s, e) {
                                    (this.o.size.pulse &&
                                        ...
                                        (this.s > this.o.size.max ||
                                            this.s < this.o.size.min) &&
                                            (this.d *= -1),
                        ...
                        _cc(h, [
                            {
                                ...
                                value: function (t) {
                                    ...
                                    if (!i.length)
                                        throw new Error(
                                            'No .finisher-header element found'
                                        );
                                    return i[0];
                                },
                            },
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    for (var s = 0; s < this.o.ac; s++) {
                                        var h = s % 4,
                                            a = new e(
                                                this.o.colors.particles[i],
                                                h,
                                                this.o
                                            );
                                        (++i >=
                                            this.o.colors.particles.length &&
                                            (i = 0),
                                            (this.ps[s] = a));
                                    }
                                },
        ...
        new FinisherHeader({
            ...
            colors: {
                background: '#270022',
                particles: ['#ff0546', '#9c173b', '#660f31'],
            },
            blending: 'lighten',
            opacity: {
                center: 0.5,
    ...
    return (
        <>
            <section id="header">
                <div className="navbar-geral">
                    <div className="title-container">
                        <Link className="header-title" to="/">
                            <picture>
                                <source
                                    srcSet="/logos/foca_logo_uncolor.svg"
                                    media="(max-width: 900px)"
                                />
                                <source
                                    srcSet="/logos/foca_logo_uncolor_typo.svg"
                                    media="(min-width: 901px)"
                                />
                                <img
                                    src="/logos/foca_logo_uncolor_typo.svg"
                                    alt="Logo Foca"
                                    className="logo-foca"
                                />
                            </picture>
                ...
                <div className="cta-container">
                    <Link
                        ...
                        className="signup-button cta-button invert"
                    ></Link>
                </div>
            </section>
            ...
            <section id="start-now">
                <div
                    className="hero-bg finisher-header"
                    style={{ width: '100%', height: '864px' }}
                ></div>
                <div className="wrapper-start">
                    <div className="hero-container">
                        <h1 className="title">
                            Diga adeus à procrastinação e foque no que importa!
                        </h1>
                        <h4 className="subtitle">
                            Transforme sua rotina em um jogo: foco, organização
                            e produtividade com o Foca.
                        </h4>
                    </div>
                    <a
                        href="/auth?register=true"
                        className="cta-button invert"
                    ></a>
                </div>
            ...
            <section id="about">
                ...
                <div className="wrapper wrapper-about">
                    <div className="about-container">
                        <h1 className="title">
                            Tá difícil focar? Relaxa, o Foca resolve.
                        </h1>
                        <h4 className="subtitle">
                            O celular vibra, a notificação chama, a vida
                            acontece... e o estudo? Fica pra depois (ou nunca).
            ...
            <section id="conheca">
                <div className="wrapper wrapper-conheca">
                    <div className="conheca-container">
                        ...
                        <h4 className="subtitle">
                            Seu aliado na guerra contra o celular, os vídeos de
                            gatinhos fofos e o “só mais uma partida”. Ele segura
                            a bronca enquanto você foca no que importa: passar,
                            aprender e vencer.
                        </h4>
                    </div>
            ...
            <section id="functions">
                ...
                <div id="rotina">
                    ...
                    <div className="wrapper wrapper-rotina">
                        <div className="rotina-container">
                            <h1 className="title">
                                Organiza sua rotina com IA
                            </h1>
                            <h4 className="subtitle">
                                No Foca, você monta sua rotina de estudo do
                                jeitinho que quiser, com pausas, prioridades e
                                até tempo pra pensar na vida (ou dar uma
                                olhadinha nos memes, vai). Aqui, quem manda é
                                você.
                            </h4>
                        </div>
                        <a
                ...
                <div id="pontos">
                    <div className="wrapper wrapper-pontos">
                        <div className="pontos-container">
                            <h1 className="title">
                                Ganha pontos sendo produtivo
                            </h1>
                            <h4 className="subtitle">
                                Estudar não precisa ser só sofrimento. Cada
                                tarefa concluída viram pontos. Quanto mais você
                                foca, mais você evolui.
                            </h4>
                        </div>
                        <a
                            href="/auth?register=true"
                ...
                <div id="notificacao">
                    <div className="image-section">
                        <img
                            src="/landing/Push notifications-amico.svg"
                            alt=""
                        />
                    </div>
                    <div className="wrapper wrapper-notificacao">
                        <div className="notificacao-container">
                            <h1 className="title">
                                Recebe notificações que te ajudam
                            </h1>
                            <h4 className="subtitle">
                                As notificações do Foca aparecem só pra dar
                                aquele toque na hora certa. São tipo um amigo
                                que te cutuca quando você tá quase escorregando
                                pra procrastinação.
                            </h4>
                        </div>
                        <a
                ...
                <div id="distracao">
                    <div className="wrapper wrapper-distracao">
                        <div className="distracao-container">
                            ...
                            <h4 className="subtitle">
                                Sabe aquele momento que você finalmente senta
                                pra estudar... e dois cliques depois tá vendo a
                                letra de uma música? Então. O Foca bloqueia
                                esses apps e jogos ladrões de atenção enquanto
                                você estuda. É tipo um segurança na porta do seu
                                foco.
                            </h4>
                        </div>
                        <a
            ...
            <section id="cta-final">
                <div className="cta-final-container">
                    <img
                        className="divider"
                        src="/landing/divider.svg"
                        alt=""
                    />
                    <h1 className="title">Tá esperando o quê?</h1>
                    <p className="subtitle">
                        Deixe de ser um procrastinador a partir de agora. Não
                        deixe o Tik Tok te vencer de novo!
                    </p>
                    <a
                        href="/auth?register=true"
                        className="cta-button invert"
                ...
                <footer>
                    <div className="footer-content">
                        ...
                        <div className="footer-image">
                            <img
                                src="/logos/foca_logo_uncolor.svg"
                                alt="Logo Foca"
                            />
                        </div>
                        <div className="footer-socials">
                            ...
                            <a
                                href="https://www.instagram.com/app.foca/"
                                target="_blank"
                        ...
                        <div className="footer-copyright">
                            <p>
                                &copy; 2025 Foca. Todos os direitos reservados.
                            </p>
                            <p>
                                <a
